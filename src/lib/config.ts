...
export const defaultConfigs: BotConfig[] = [
  {
    ...
    risk: { ...risk },
    strategy: { kind: "momentum", symbol: "frxEURUSD", tickWindow: 16, threshold: 0.66, holdTicks: 5, maxSpreadPips: 1.2, stopLossPips: 2.4, takeProfitPips: 2.8, minimumVolatilityPips: 0.9 }
  },
  {
    ...
    strategy: { kind: "mean-reversion", symbol: "frxEURUSD", tickWindow: 28, threshold: 1.55, holdTicks: 7, maxSpreadPips: 1.0, stopLossPips: 2.2, takeProfitPips: 2.2, minimumVolatilityPips: 1.1 }
  },
  {
    ...
    strategy: { kind: "breakout", symbol: "frxEURUSD", tickWindow: 24, threshold: 0.70, holdTicks: 8, maxSpreadPips: 1.2, stopLossPips: 2.6, takeProfitPips: 3.4, minimumVolatilityPips: 1.2 }
  },
  {
    ...
    risk: { ...risk, cooldownSeconds: 60 },
    strategy: { kind: "pullback", symbol: "frxEURUSD", tickWindow: 32, threshold: 0.40, holdTicks: 4, maxSpreadPips: 1.0, stopLossPips: 2.2, takeProfitPips: 2.6, minimumVolatilityPips: 1.0 }
  }
];
